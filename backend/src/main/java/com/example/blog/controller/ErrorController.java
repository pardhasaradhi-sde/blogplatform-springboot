...
public class ErrorController {
    ...
    public ResponseEntity<ApiErrorResponse> handleIllegalException(IllegalArgumentException e) {
    ...
    public ResponseEntity<ApiErrorResponse> handleIllegalException(IllegalStateException e) {
